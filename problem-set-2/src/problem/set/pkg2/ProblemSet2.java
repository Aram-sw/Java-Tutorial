package problem.set.pkg2;

/**
 *
 * @author Alaa-sw 03.03.2018
 */
...
powered-up, and nally, \Wander." is printed if the player is not visible.
         */
...
otherwise.
       */
        ...
        /*
        Assume you have access to a double variable called time. Write code that assigns a dierent
...
if the time variable does not satisfy either condition, set timeOfDay to \night".
        */
...
7 = Sunday
        */
        ...
        /*
        Imagine that the variables rewinding and playbackPosition could have dierent values
...
playbackPosition = playbackPosition - rewindAmount;
        */
        ...
        The line
playbackPosition = playbackPosition - rewindAmount;
references a variable out of scope. When a variable is dened inside an if block, such as
if (rewinding) {
double rewindAmount = 0.1;
}
...
be sure after the if block that the variable rewindAmount was ever dened. For this code
...
a dierent value based on the day of the week. For Monday, give it the value \Gym in the
